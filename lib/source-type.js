    ...
    GITLAB: {
        ...
        options: function () {
            return {
                ...
                domain: fis.get('scaffold.gitlabDomain')
            };
        }
    } // ,
    // LIGHTS: {value: 'lights'}
...
/**
 * 判断给定的仓库类型是否有 namespace
 *
 * @param {string} type 类型
 * @return {boolean}
 */
exports.hasNamespace = function (type) {
    return (SOURCE_TYPE.GITHUB.value === type
    || SOURCE_TYPE.GITLAB.value === type);
};
